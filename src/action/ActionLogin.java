	...
	public static void loginAttempt(HttpServletRequest request, HttpServletResponse response) {
		...
		if(validation.isValidate()) {
			...
			if(user != null) {
				...
				// If the user ticks the Automatic connection box
