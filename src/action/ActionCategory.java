	...
	public static int getSelectedCategory(HttpServletRequest request, HttpServletResponse response) {
		...
		if(paramCategory != null) {
			try {
				...
				// If the user enters himself a value for the category parameter in the address bar
				// then if the category is invalid, then the selected category will become 1 (which represents all categories)
